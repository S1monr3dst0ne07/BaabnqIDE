...
class cCodeEditor(QtWidgets.QPlainTextEdit):
    ...
    class cSyntaxHighlighter(QtGui.QSyntaxHighlighter):
        ...
        xRules = [
                ...
                (r'\b(?:put|print|input|putchr|asm|use)\b',          xStyles["normalCommands"]),
                (r'\b(?:pull|push|sub|return)\b',                    xStyles["stackCommands"]),
                (r'=|\<|\>|==|!=|\+|-|&|\||\^|\>\>|\<\<|~',          xStyles["ops"]),
                (r'\b(?:new|free|static)\b',                         xStyles["memAlloc"]),
                (r'->|<-',                                           xStyles["memAlloc"]),
                (r'\b(?:lab|jump)\b',                                xStyles["jumpOps"]),
                (r"\W\d+\W",                                         xStyles["const"]),
                (r'_[^ ]*',                                          xStyles["vars"]),
                (r'\(|\)',                                           xStyles["ops"]),
                (r'\".*$',                                           xStyles["fazzedOut"]),
                (r';',                                               xStyles["fazzedOut"]),
